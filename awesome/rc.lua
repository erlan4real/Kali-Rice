...
beautiful.init("/home/erlangga/.config/awesome/mytheme.lua")
...
awful.key({ modkey, "Shift" }, "Down", function()
  ...
  if c.floating or c.first_tag and c.first_tag.layout.name == "floating" then
    ...
    -- Launch Rofi          
    awful.key({modkey},          "d",  function () awful.util.spawn(".config/rofi/launchers/type-6/launcher.sh")end,
...
-- Border Color
client.connect_signal("focus", function(c) c.border_color = "#4554FF" border_width = "10px" end)
client.connect_signal("unfocus", function(c) c.border_color = "#e66e7f" end)
...
awful.spawn.with_shell("polybar mybar2")
awful.spawn.with_shell("polybar mybar3")
-- brightness manajement
autorun = true
autorunApps =
{
   "xfce4-power-manager",
